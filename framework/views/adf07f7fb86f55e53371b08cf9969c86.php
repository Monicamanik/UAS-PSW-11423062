        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="mb-2 bg-white rounded cursor-pointer">
                <a href="<?php echo e(route('dashboard.index')); ?>"
                    ...
                    <?php echo e(in_array(Route::currentRouteName(), ['dashboard.index', 'chart.dailyGuest']) ? 'active' : ''); ?>
            ...
            <?php if(auth()->user()->role == 'Super' || auth()->user()->role == 'Admin'): ?>
                ...
                <li class="mb-2 bg-white rounded cursor-pointer">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('room.index')); ?>">field</a></li>
...
<?php /**PATH D:\fil\Laravel-Hotel-main\resources\views/template/include/_sidebar.blade.php ENDPATH**/ ?>